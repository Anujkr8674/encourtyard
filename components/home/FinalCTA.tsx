            ...
            <div className="pt-2 space-y-3.5">
              ...
              <div className="flex flex-wrap items-center gap-3">
                <Button
                  ...
                  variant="white"
                  size="lg"
                  className="font-semibold shadow-2xl text-[#263626]"
                ...
                <Button
                  ...
                  variant="outline"
                  size="lg"
                  className="border-white/70 text-white hover:bg-white hover:text-[#181F18] font-semibold"
              ...
              <div className="flex flex-wrap items-center gap-3 pt-1">
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-[#25D366]/20 hover:bg-[#25D366] text-white border border-[#25D366]/40 hover:border-[#25D366] backdrop-blur-md font-sans text-xs sm:text-sm font-semibold transition-all duration-300 shadow-md hover:shadow-[0_4px_16px_rgba(37,211,102,0.35)] group"
                >
                  <svg className="w-4 h-4 fill-current text-[#25D366] group-hover:text-white transition-colors shrink-0" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-white/10 hover:bg-white/20 text-white border border-white/20 hover:border-white/40 backdrop-blur-md font-sans text-xs sm:text-sm font-semibold transition-all duration-300 shadow-md group"
                >
