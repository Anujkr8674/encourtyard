    ...
    <section className="py-14 sm:py-20 lg:py-24 secondary-section-bg border-b border-[#E5E1D8] relative overflow-hidden select-none">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div
          ...
          className={`flex gap-3.5 sm:gap-4 lg:gap-5 overflow-x-auto scroll-smooth snap-x snap-mandatory py-2 sm:py-3 no-scrollbar -mx-4 px-4 sm:mx-0 sm:px-0 relative z-10 items-end mb-6 sm:mb-8 ${
          ...
          {CATEGORIES_DATA.map((category, index) => {
            ...
            if (isFeatured) {
              return (
                <div
                  ...
                  className={`group rounded-2xl border overflow-hidden transition-all duration-300 transform hover:-translate-y-1.5 flex flex-col justify-end w-[200px] sm:w-[230px] lg:w-[230px] shrink-0 snap-start cursor-pointer select-none ${
                    isActive
            ...
            return (
              <div
                ...
                onMouseLeave={() => setHoveredCategoryId(null)}
                onClick={(e) => handleCardClick(e, category.id)}
                className={`group rounded-2xl border overflow-hidden transition-all duration-300 transform hover:-translate-y-1.5 flex flex-col justify-between w-[205px] sm:w-[240px] lg:w-[240px] shrink-0 snap-start h-full cursor-pointer select-none ${
                  isActive
                    ? 'bg-[#263626] text-white border-[#263626] shadow-2xl scale-[1.02] ring-2 ring-[#263626]/20'
                    : 'bg-white text-[#181F18] border-[#E5E1D8] shadow-warm hover:shadow-2xl hover:border-[#263626]'
                }`}
            ...
            <div className="hidden sm:flex items-center gap-3 self-start sm:self-auto shrink-0 flex-wrap">
              ...
              <div className="flex items-center gap-1.5">
                <button
                  ...
                  className={`w-8 h-8 rounded-full border border-[#D5CEC2] flex items-center justify-center transition-all cursor-pointer shadow-xs ${
                    canSubScrollLeft
                      ? 'bg-white text-[#181F18] hover:bg-[#263626] hover:text-white hover:border-[#263626]'
                      : 'bg-[#EAE5DC] text-[#A3B0A3] opacity-40 cursor-not-allowed'
                  }`}
